...
namespace MyAccount.PageObjects
{
    public class MyAccountInboxPage
    {
        ...
        {
            genericHelper.waitForElement(AllMessagesText);
        ...
        public string GetContactCustomerServiceHeaderText()
        {
            genericHelper.waitForElement(ContactCustomerServiceHeader);
            return ContactCustomerServiceHeader.Text;
        }

        public void SelectAccountDropdown(int index)
        {
            genericHelper.selectValueFromDropdown(AccountDropdown, index);
        }

        public void SelectSubjectDropdown(int index)
        {
        ...
        {
            genericHelper.waitForElement(ThankYouMessageText);
